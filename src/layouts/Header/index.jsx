...
//                 <div className='w-full max-w-7xl md:flex justify-between items-center'>
...
//                                 {/* <p className='text-sm lg:text-base text-[var(--white)]'>(11) 3368-3693</p> */}
...
//             {/* Header */}
//             <div className='w-full flex justify-center items-center px-5 md:px-12 py-3 md:py-4'>
//                 <div className='w-full max-w-7xl flex justify-between md:justify-center items-center'>
//                     <Link to={'/'}>
//                         <img 
//                             className='max-w-18 md:max-w-22 lg:max-w-[7.5rem]'
...
//                                         <li role="none">
//                                             <Link role="menuitem" to='/categorias/sacolas-ecobag-personalizadas'
//                                             className='block px-3 py-1 border-b border-[var(--shani-purple)] rounded-t-lg transition-colors duration-200 hover:bg-[var(--perfume-haze)] hover:text-[var(--shani-purple)] hover:font-semibold'>
//                                                 Sacolas Ecobags Personalizadas
//                                             </Link>
//                                         </li>
...
//                                         <li role="none">
//                                             <Link role="menuitem" to='/categorias/sacolas-pvc-personalizadas'
//                                             className='block px-3 py-1 border-b border-[var(--shani-purple)] transition-colors duration-200 hover:bg-[var(--perfume-haze)] hover:text-[var(--shani-purple)] hover:font-semibold'>
//                                                 Sacolas PVC Personalizadas
//                                             </Link>
//                                         </li>
...
//                         <div className={`absolute md:hidden w-40 overflow-hidden top-10 right-5 bg-[var(--carbon-fiber)] rounded-lg shadow-md transition-all duration-500 ${isMenuOpen ? "max-h-100" : "max-h-0"} ${isOpen ? "w-fit max-h-112 transition-all duration-500" : "max-h-0 transition-all duration-500"}`}>
...
//                                                 <li role="none" className={getLiClasses('/categorias/sacolas-ecobag-personalizadas')}>
//                                                     <Link
//                                                         role="menuitem"
//                                                         to='/categorias/sacolas-ecobag-personalizadas'
...
//                                                 <li role="none" className={getLiClasses('/categorias/sacolas-pvc-personalizadas')}>
//                                                     <Link
//                                                     role="menuitem"
//                                                     to='/categorias/sacolas-pvc-personalizadas'
//                                                     className='block p-1 text-white md:text-[var(--carbon-fiber)] border-b border-[var(--shani-purple)] truncate'
//                                                     >
//                                                         Sacolas PVC Personalizadas
//                                                     </Link>
...
//             <div className={`transition-all duration-300 ${isSticky ? 'opacity-0' : 'opacity-100 px-5'}`}>
    ...
    return (
        <header className={`w-full sticky top-0 z-50 justify-center items-center bg-white transition-shadow duration-500 ${isSticky ? "shadow-md" : ""}`}>
            ...
            <div className={`hidden md:h-8 lg:h-11 md:flex justify-center items-center px-12 bg-[var(--carbon-fiber)] transition-all duration-500 ${isSticky ? 'opacity-0 max-h-0 overflow-hidden' : 'opacity-100 max-h-12'}`} >
                ...
                {/* Medidas antigas da Div abaixo w-70 md:w-167 lg:w-255 xl:w-312 ---- Novas medidas: w-full max-w-7xl */}
            ...
            {/* Medidas antigas da Div abaixo da div seguinte: w-70 md:w-167 lg:w-255 xl:w-312 ---- Novas medidas: w-full max-w-7xl */}
            {/* Header */}
